...
" Diff
hi Added      guifg=#FFFFFF guibg=#009000 gui=Bold ctermbg=10 ctermfg=15 cterm=none
hi Changed    guifg=#FFFFFF guibg=#19bbfb gui=Bold ctermbg=11 ctermfg=0  cterm=none
hi Removed    guifg=#FFFFFF guibg=#D00000 gui=Bold ctermbg=9  ctermfg=15 cterm=none
" Syntax
...
hi DiagnosticWarn guifg=yellow gui=Bold guibg=fg
hi DiagnosticHint gui=Bold guibg=fg guifg=#FFFFFF
hi DiagnosticError gui=Bold guibg=fg
